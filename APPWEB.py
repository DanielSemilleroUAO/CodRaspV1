...
class comunicacion(object):
    ...
    def concatenar_dato(self, archivo):
        lleno = []
        dato_pa,a = self.Separar(self.leer_valores("MEDIDA_CONTENEDORES/CPC.txt"))
        lleno.append(a)
        dato_pl,a= self.Separar(self.leer_valores("MEDIDA_CONTENEDORES/CP.txt"))
        lleno.append(a)
        dato_or,a = self.Separar(self.leer_valores("MEDIDA_CONTENEDORES/COR.txt"))
        lleno.append(a)
        dato_vi,a = self.Separar(self.leer_valores("MEDIDA_CONTENEDORES/CV.txt"))
        lleno.append(a)
        dato_me,a = self.Separar(self.leer_valores("MEDIDA_CONTENEDORES/CM.txt"))
        lleno.append(a)
        dato_ot,a = self.Separar(self.leer_valores("MEDIDA_CONTENEDORES/CO.txt"))
        lleno.append(a)
        ...
        for i in range(len(lleno)):
            if lleno[i] == "*":
                cont_lleno = "*"
                break
        latitud,longitud = self.Separar(self.leer_valores("UBICACION/UBICACION.txt"))
...
while True:
    try:
        ...
        AppWeb.concatenar_dato("HISTORIAL/HISTORIAL.txt")
        if(AppWeb.sondeo() is True):
            print("DATO ENVIADO")
            AppWeb.envio_APP_WEB("HISTORIAL/HISTORIAL.txt")
    except:
        pass
